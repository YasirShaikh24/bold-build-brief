...
// Simple SVG Icons
const SendIcon = ({ className = "w-4 h-4 sm:w-5 sm:h-5 mr-2" }) => (
...
const ChevronDownIcon = ({ className = "w-3 h-3 sm:w-4 sm:h-4 text-gray-400" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const ContactForm = () => {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      {/* Content */}
      <div className="relative z-10 pt-20 sm:pt-32 pb-20 px-3 sm:px-6 lg:px-12" ref={containerRef}>
          ...
          >
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
                ...
                {/* Phone Field with Country Code - Mobile Optimized */}
                <div>
